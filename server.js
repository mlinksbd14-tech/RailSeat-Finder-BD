...
// =========================================================================
// 🚉 LIVE STATION PIDS (Platform Information Display Screen) ENDPOINT
// =========================================================================
const PIDS_INTERCITY_SCHEDULES = {
  // Dhaka - Chattogram Corridor
  '701': { name: 'Suborno Express', from: 'Chattogram', to: 'Dhaka', dept: '07:00', arr: '12:20', stops: [{ city: 'Dhaka_Airport', arr: '11:55', dept: '12:00' }], offDay: 'Monday' },
  '702': { name: 'Suborno Express', from: 'Dhaka', to: 'Chattogram', dept: '16:30', arr: '21:50', stops: [{ city: 'Dhaka_Airport', arr: '16:55', dept: '17:00' }], offDay: 'Monday' },
  '703': { name: 'Mahanagar Godhuli', from: 'Chattogram', to: 'Dhaka', dept: '15:00', arr: '21:10', stops: [{ city: 'Feni', arr: '16:20', dept: '16:25' }, { city: 'Cumilla', arr: '17:15', dept: '17:20' }, { city: 'Akhaura', arr: '18:10', dept: '18:15' }, { city: 'Brahmanbaria', arr: '18:35', dept: '18:40' }, { city: 'Bhairab_Bazar', arr: '19:10', dept: '19:15' }, { city: 'Dhaka_Airport', arr: '20:40', dept: '20:45' }], offDay: 'Sunday' },
  '704': { name: 'Mahanagar Provati', from: 'Dhaka', to: 'Chattogram', dept: '07:45', arr: '14:00', stops: [{ city: 'Dhaka_Airport', arr: '08:10', dept: '08:15' }, { city: 'Bhairab_Bazar', arr: '09:30', dept: '09:35' }, { city: 'Brahmanbaria', arr: '10:05', dept: '10:10' }, { city: 'Akhaura', arr: '10:30', dept: '10:35' }, { city: 'Cumilla', arr: '11:25', dept: '11:30' }, { city: 'Feni', arr: '12:20', dept: '12:25' }], offDay: 'None' },
  '721': { name: 'Mahanagar Express', from: 'Chattogram', to: 'Dhaka', dept: '12:30', arr: '19:10', stops: [{ city: 'Feni', arr: '13:50', dept: '13:55' }, { city: 'Cumilla', arr: '14:45', dept: '14:50' }, { city: 'Akhaura', arr: '15:40', dept: '15:45' }, { city: 'Brahmanbaria', arr: '16:05', dept: '16:10' }, { city: 'Bhairab_Bazar', arr: '16:40', dept: '16:45' }, { city: 'Dhaka_Airport', arr: '18:35', dept: '18:40' }], offDay: 'Sunday' },
  '722': { name: 'Mahanagar Express', from: 'Dhaka', to: 'Chattogram', dept: '21:20', arr: '04:50', stops: [{ city: 'Dhaka_Airport', arr: '21:45', dept: '21:50' }, { city: 'Bhairab_Bazar', arr: '23:10', dept: '23:15' }, { city: 'Brahmanbaria', arr: '23:45', dept: '23:50' }, { city: 'Akhaura', arr: '00:15', dept: '00:20' }, { city: 'Cumilla', arr: '01:10', dept: '01:15' }, { city: 'Feni', arr: '02:15', dept: '02:20' }], offDay: 'Sunday' },
  '787': { name: 'Sonar Bangla Express', from: 'Dhaka', to: 'Chattogram', dept: '07:00', arr: '12:15', stops: [{ city: 'Dhaka_Airport', arr: '07:22', dept: '07:27' }], offDay: 'Wednesday' },
  '788': { name: 'Sonar Bangla Express', from: 'Chattogram', to: 'Dhaka', dept: '16:45', arr: '22:00', stops: [{ city: 'Dhaka_Airport', arr: '21:30', dept: '21:35' }], offDay: 'Tuesday' },
  '741': { name: 'Turna Express', from: 'Chattogram', to: 'Dhaka', dept: '23:00', arr: '05:15', stops: [{ city: 'Feni', arr: '00:15', dept: '00:20' }, { city: 'Cumilla', arr: '01:10', dept: '01:15' }, { city: 'Akhaura', arr: '02:05', dept: '02:10' }, { city: 'Brahmanbaria', arr: '02:30', dept: '02:35' }, { city: 'Bhairab_Bazar', arr: '03:05', dept: '03:10' }, { city: 'Dhaka_Airport', arr: '04:45', dept: '04:50' }], offDay: 'None' },
  '742': { name: 'Turna Express', from: 'Dhaka', to: 'Chattogram', dept: '23:30', arr: '06:00', stops: [{ city: 'Dhaka_Airport', arr: '23:55', dept: '00:00' }, { city: 'Bhairab_Bazar', arr: '01:15', dept: '01:20' }, { city: 'Brahmanbaria', arr: '01:45', dept: '01:50' }, { city: 'Akhaura', arr: '02:15', dept: '02:20' }, { city: 'Cumilla', arr: '03:05', dept: '03:10' }, { city: 'Feni', arr: '04:05', dept: '04:10' }], offDay: 'None' },
  
  // Cox's Bazar Corridor
  '813': { name: 'Cox\'s Bazar Express', from: 'Chattogram', to: 'Cox\'s Bazar', dept: '07:00', arr: '09:50', stops: [{ city: 'Dohazari', arr: '07:55', dept: '07:58' }, { city: 'Chakaria', arr: '08:50', dept: '08:53' }, { city: 'Ramu', arr: '09:25', dept: '09:28' }], offDay: 'Monday' },
  '814': { name: 'Cox\'s Bazar Express', from: 'Cox\'s Bazar', to: 'Dhaka', dept: '12:30', arr: '21:10', stops: [{ city: 'Ramu', arr: '12:48', dept: '12:50' }, { city: 'Chakaria', arr: '13:20', dept: '13:23' }, { city: 'Chattogram', arr: '15:20', dept: '15:40' }, { city: 'Dhaka_Airport', arr: '20:30', dept: '20:35' }], offDay: 'Monday' },
  '815': { name: 'Parjotok Express', from: 'Dhaka', to: 'Cox\'s Bazar', dept: '06:15', arr: '15:00', stops: [{ city: 'Dhaka_Airport', arr: '06:38', dept: '06:43' }, { city: 'Chattogram', arr: '11:20', dept: '11:40' }, { city: 'Chakaria', arr: '13:45', dept: '13:48' }, { city: 'Ramu', arr: '14:20', dept: '14:23' }], offDay: 'Sunday' },
  '816': { name: 'Parjotok Express', from: 'Cox\'s Bazar', to: 'Dhaka', dept: '20:00', arr: '04:30', stops: [{ city: 'Ramu', arr: '20:18', dept: '20:20' }, { city: 'Chakaria', arr: '20:50', dept: '20:53' }, { city: 'Chattogram', arr: '22:50', dept: '23:10' }, { city: 'Dhaka_Airport', arr: '03:55', dept: '04:00' }], offDay: 'Sunday' },

  // Dhaka - Sylhet Corridor
  '709': { name: 'Parabat Express', from: 'Dhaka', to: 'Sylhet', dept: '06:20', arr: '13:00', stops: [{ city: 'Dhaka_Airport', arr: '06:45', dept: '06:50' }, { city: 'Bhairab_Bazar', arr: '08:05', dept: '08:10' }, { city: 'Brahmanbaria', arr: '08:35', dept: '08:40' }, { city: 'Akhaura', arr: '09:05', dept: '09:10' }, { city: 'Shaistaganj', arr: '10:10', dept: '10:15' }, { city: 'Sreemangal', arr: '11:00', dept: '11:05' }, { city: 'Kulaura', arr: '11:55', dept: '12:00' }, { city: 'Maijgaon', arr: '12:25', dept: '12:28' }], offDay: 'Tuesday' },
  '710': { name: 'Parabat Express', from: 'Sylhet', to: 'Dhaka', dept: '15:45', arr: '22:25', stops: [{ city: 'Maijgaon', arr: '16:15', dept: '16:18' }, { city: 'Kulaura', arr: '16:45', dept: '16:50' }, { city: 'Sreemangal', arr: '17:40', dept: '17:45' }, { city: 'Shaistaganj', arr: '18:30', dept: '18:35' }, { city: 'Akhaura', arr: '19:40', dept: '19:45' }, { city: 'Brahmanbaria', arr: '20:10', dept: '20:15' }, { city: 'Bhairab_Bazar', arr: '20:45', dept: '20:50' }, { city: 'Dhaka_Airport', arr: '21:55', dept: '22:00' }], offDay: 'Tuesday' },
  '717': { name: 'Jayantika Express', from: 'Dhaka', to: 'Sylhet', dept: '11:15', arr: '19:00', stops: [{ city: 'Dhaka_Airport', arr: '11:40', dept: '11:45' }, { city: 'Bhairab_Bazar', arr: '13:05', dept: '13:10' }, { city: 'Brahmanbaria', arr: '13:40', dept: '13:45' }, { city: 'Akhaura', arr: '14:15', dept: '14:20' }, { city: 'Shaistaganj', arr: '15:35', dept: '15:40' }, { city: 'Sreemangal', arr: '16:30', dept: '16:35' }, { city: 'Kulaura', arr: '17:35', dept: '17:40' }], offDay: 'Thursday' },
  '718': { name: 'Jayantika Express', from: 'Sylhet', to: 'Dhaka', dept: '08:45', arr: '16:00', stops: [{ city: 'Kulaura', arr: '09:45', dept: '09:50' }, { city: 'Sreemangal', arr: '10:40', dept: '10:45' }, { city: 'Shaistaganj', arr: '11:35', dept: '11:40' }, { city: 'Akhaura', arr: '12:50', dept: '12:55' }, { city: 'Brahmanbaria', arr: '13:25', dept: '13:30' }, { city: 'Bhairab_Bazar', arr: '14:05', dept: '14:10' }, { city: 'Dhaka_Airport', arr: '15:25', dept: '15:30' }], offDay: 'Tuesday' },
  '739': { name: 'Upaban Express', from: 'Dhaka', to: 'Sylhet', dept: '20:30', arr: '04:30', stops: [{ city: 'Dhaka_Airport', arr: '20:55', dept: '21:00' }, { city: 'Bhairab_Bazar', arr: '22:25', dept: '22:30' }, { city: 'Brahmanbaria', arr: '23:05', dept: '23:10' }, { city: 'Akhaura', arr: '23:45', dept: '23:50' }, { city: 'Shaistaganj', arr: '01:05', dept: '01:10' }, { city: 'Sreemangal', arr: '02:00', dept: '02:05' }, { city: 'Kulaura', arr: '03:00', dept: '03:05' }], offDay: 'Wednesday' },
  '740': { name: 'Upaban Express', from: 'Sylhet', to: 'Dhaka', dept: '23:30', arr: '06:45', stops: [{ city: 'Kulaura', arr: '00:30', dept: '00:35' }, { city: 'Sreemangal', arr: '01:30', dept: '01:35' }, { city: 'Shaistaganj', arr: '02:25', dept: '02:30' }, { city: 'Akhaura', arr: '03:40', dept: '03:45' }, { city: 'Brahmanbaria', arr: '04:15', dept: '04:20' }, { city: 'Bhairab_Bazar', arr: '04:55', dept: '05:00' }, { city: 'Dhaka_Airport', arr: '06:15', dept: '06:20' }], offDay: 'Monday' },
  '773': { name: 'Kalni Express', from: 'Dhaka', to: 'Sylhet', dept: '15:00', arr: '21:30', stops: [{ city: 'Dhaka_Airport', arr: '15:25', dept: '15:30' }, { city: 'Bhairab_Bazar', arr: '16:45', dept: '16:50' }, { city: 'Brahmanbaria', arr: '17:20', dept: '17:25' }, { city: 'Azampur', arr: '17:50', dept: '17:52' }, { city: 'Shaistaganj', arr: '18:40', dept: '18:45' }, { city: 'Sreemangal', arr: '19:30', dept: '19:35' }, { city: 'Shamshernagar', arr: '19:55', dept: '19:58' }, { city: 'Kulaura', arr: '20:25', dept: '20:30' }, { city: 'Maijgaon', arr: '20:55', dept: '20:58' }], offDay: 'Friday' },
  '774': { name: 'Kalni Express', from: 'Sylhet', to: 'Dhaka', dept: '06:15', arr: '12:55', stops: [{ city: 'Maijgaon', arr: '06:45', dept: '06:48' }, { city: 'Kulaura', arr: '07:15', dept: '07:20' }, { city: 'Shamshernagar', arr: '07:45', dept: '07:48' }, { city: 'Sreemangal', arr: '08:10', dept: '08:15' }, { city: 'Shaistaganj', arr: '09:00', dept: '09:05' }, { city: 'Brahmanbaria', arr: '10:20', dept: '10:25' }, { city: 'Bhairab_Bazar', arr: '10:55', dept: '11:00' }, { city: 'Dhaka_Airport', arr: '12:20', dept: '12:25' }], offDay: 'Friday' },

  // Dhaka - Rajshahi Corridor
  '753': { name: 'Silk City Express', from: 'Dhaka', to: 'Rajshahi', dept: '14:45', arr: '20:35', stops: [{ city: 'Dhaka_Airport', arr: '15:10', dept: '15:15' }, { city: 'Joydebpur', arr: '15:40', dept: '15:45' }, { city: 'Tangail', arr: '16:45', dept: '16:50' }, { city: 'Bangabandhu_Bridge_East', arr: '17:15', dept: '17:20' }, { city: 'Ullapara', arr: '18:05', dept: '18:10' }, { city: 'Chatmohar', arr: '18:40', dept: '18:45' }, { city: 'Ishwardi_Bypass', arr: '19:15', dept: '19:18' }, { city: 'Natore', arr: '19:45', dept: '19:50' }], offDay: 'Sunday' },
  '754': { name: 'Silk City Express', from: 'Rajshahi', to: 'Dhaka', dept: '07:40', arr: '13:30', stops: [{ city: 'Natore', arr: '08:25', dept: '08:30' }, { city: 'Ishwardi_Bypass', arr: '09:00', dept: '09:03' }, { city: 'Chatmohar', arr: '09:30', dept: '09:35' }, { city: 'Ullapara', arr: '10:05', dept: '10:10' }, { city: 'Bangabandhu_Bridge_East', arr: '10:55', dept: '11:00' }, { city: 'Tangail', arr: '11:25', dept: '11:30' }, { city: 'Joydebpur', arr: '12:30', dept: '12:35' }, { city: 'Dhaka_Airport', arr: '13:00', dept: '13:05' }], offDay: 'Sunday' },
  '759': { name: 'Padma Express', from: 'Dhaka', to: 'Rajshahi', dept: '22:45', arr: '04:30', stops: [{ city: 'Dhaka_Airport', arr: '23:10', dept: '23:15' }, { city: 'Joydebpur', arr: '23:45', dept: '23:50' }, { city: 'Tangail', arr: '00:50', dept: '00:55' }, { city: 'Ullapara', arr: '02:05', dept: '02:10' }, { city: 'Chatmohar', arr: '02:40', dept: '02:45' }, { city: 'Ishwardi_Bypass', arr: '03:15', dept: '03:18' }, { city: 'Natore', arr: '03:45', dept: '03:50' }], offDay: 'Tuesday' },
  '760': { name: 'Padma Express', from: 'Rajshahi', to: 'Dhaka', dept: '16:00', arr: '21:40', stops: [{ city: 'Natore', arr: '16:45', dept: '16:50' }, { city: 'Ishwardi_Bypass', arr: '17:20', dept: '17:23' }, { city: 'Chatmohar', arr: '17:50', dept: '17:55' }, { city: 'Ullapara', arr: '18:25', dept: '18:30' }, { city: 'Bangabandhu_Bridge_East', arr: '19:15', dept: '19:20' }, { city: 'Tangail', arr: '19:45', dept: '19:50' }, { city: 'Joydebpur', arr: '20:45', dept: '20:50' }, { city: 'Dhaka_Airport', arr: '21:12', dept: '21:17' }], offDay: 'Tuesday' },
  '769': { name: 'Dhumketu Express', from: 'Dhaka', to: 'Rajshahi', dept: '06:00', arr: '11:40', stops: [{ city: 'Dhaka_Airport', arr: '06:25', dept: '06:30' }, { city: 'Joydebpur', arr: '07:00', dept: '07:05' }, { city: 'Tangail', arr: '08:05', dept: '08:10' }, { city: 'Ullapara', arr: '09:20', dept: '09:25' }, { city: 'Chatmohar', arr: '09:55', dept: '10:00' }, { city: 'Ishwardi_Bypass', arr: '10:30', dept: '10:33' }, { city: 'Natore', arr: '11:00', dept: '11:05' }], offDay: 'Thursday' },
  '770': { name: 'Dhumketu Express', from: 'Rajshahi', to: 'Dhaka', dept: '23:20', arr: '05:00', stops: [{ city: 'Natore', arr: '00:05', dept: '00:10' }, { city: 'Ishwardi_Bypass', arr: '00:40', dept: '00:43' }, { city: 'Chatmohar', arr: '01:10', dept: '01:15' }, { city: 'Ullapara', arr: '01:45', dept: '01:50' }, { city: 'Bangabandhu_Bridge_East', arr: '02:35', dept: '02:40' }, { city: 'Tangail', arr: '03:05', dept: '03:10' }, { city: 'Joydebpur', arr: '04:05', dept: '04:10' }, { city: 'Dhaka_Airport', arr: '04:32', dept: '04:37' }], offDay: 'Wednesday' },
  '791': { name: 'Banalata Express', from: 'Dhaka', to: 'Chapainawabganj', dept: '13:30', arr: '19:10', stops: [{ city: 'Dhaka_Airport', arr: '13:52', dept: '13:57' }, { city: 'Rajshahi', arr: '18:00', dept: '18:15' }], offDay: 'Friday' },
  '792': { name: 'Banalata Express', from: 'Chapainawabganj', to: 'Dhaka', dept: '06:00', arr: '11:30', stops: [{ city: 'Rajshahi', arr: '07:00', dept: '07:15' }, { city: 'Dhaka_Airport', arr: '11:00', dept: '11:05' }], offDay: 'Friday' },

  // Dhaka - North Bengal (Panchagarh / Rangpur / Lalmonirhat / Kurigram / Chilahati)
  '705': { name: 'Ekota Express', from: 'Dhaka', to: 'Panchagarh', dept: '10:15', arr: '21:00', stops: [{ city: 'Dhaka_Airport', arr: '10:40', dept: '10:45' }, { city: 'Joydebpur', arr: '11:15', dept: '11:20' }, { city: 'Tangail', arr: '12:25', dept: '12:30' }, { city: 'Santahar', arr: '15:15', dept: '15:20' }, { city: 'Parbatipur', arr: '17:40', dept: '17:50' }, { city: 'Dinajpur', arr: '18:35', dept: '18:40' }, { city: 'Thakurgaon', arr: '19:45', dept: '19:50' }], offDay: 'None' },
  '706': { name: 'Ekota Express', from: 'Panchagarh', to: 'Dhaka', dept: '21:10', arr: '07:45', stops: [{ city: 'Thakurgaon', arr: '22:05', dept: '22:10' }, { city: 'Dinajpur', arr: '23:15', dept: '23:20' }, { city: 'Parbatipur', arr: '00:05', dept: '00:15' }, { city: 'Santahar', arr: '02:35', dept: '02:40' }, { city: 'Tangail', arr: '05:30', dept: '05:35' }, { city: 'Joydebpur', arr: '06:40', dept: '06:45' }, { city: 'Dhaka_Airport', arr: '07:10', dept: '07:15' }], offDay: 'None' },
  '757': { name: 'Drutajan Express', from: 'Dhaka', to: 'Panchagarh', dept: '20:00', arr: '06:30', stops: [{ city: 'Dhaka_Airport', arr: '20:25', dept: '20:30' }, { city: 'Joydebpur', arr: '21:00', dept: '21:05' }, { city: 'Santahar', arr: '00:50', dept: '00:55' }, { city: 'Parbatipur', arr: '03:15', dept: '03:25' }, { city: 'Dinajpur', arr: '04:10', dept: '04:15' }], offDay: 'None' },
  '758': { name: 'Drutajan Express', from: 'Panchagarh', to: 'Dhaka', dept: '08:20', arr: '18:30', stops: [{ city: 'Dinajpur', arr: '10:25', dept: '10:30' }, { city: 'Parbatipur', arr: '11:15', dept: '11:25' }, { city: 'Santahar', arr: '13:45', dept: '13:50' }, { city: 'Dhaka_Airport', arr: '17:55', dept: '18:00' }], offDay: 'None' },
  '793': { name: 'Panchagarh Express', from: 'Dhaka', to: 'Panchagarh', dept: '22:45', arr: '08:50', stops: [{ city: 'Dhaka_Airport', arr: '23:08', dept: '23:13' }, { city: 'Santahar', arr: '03:20', dept: '03:25' }, { city: 'Parbatipur', arr: '05:40', dept: '05:50' }, { city: 'Dinajpur', arr: '06:35', dept: '06:40' }], offDay: 'None' },
  '794': { name: 'Panchagarh Express', from: 'Panchagarh', to: 'Dhaka', dept: '12:30', arr: '22:35', stops: [{ city: 'Dinajpur', arr: '14:35', dept: '14:40' }, { city: 'Parbatipur', arr: '15:25', dept: '15:35' }, { city: 'Santahar', arr: '17:50', dept: '17:55' }, { city: 'Dhaka_Airport', arr: '22:05', dept: '22:10' }], offDay: 'None' },
  '771': { name: 'Rangpur Express', from: 'Dhaka', to: 'Rangpur', dept: '09:10', arr: '17:50', stops: [{ city: 'Dhaka_Airport', arr: '09:35', dept: '09:40' }, { city: 'Joydebpur', arr: '10:10', dept: '10:15' }, { city: 'Bogura', arr: '14:20', dept: '14:25' }, { city: 'Gaibandha', arr: '16:00', dept: '16:05' }, { city: 'Kaunia', arr: '17:05', dept: '17:10' }], offDay: 'Monday' },
  '772': { name: 'Rangpur Express', from: 'Rangpur', to: 'Dhaka', dept: '20:10', arr: '05:30', stops: [{ city: 'Kaunia', arr: '20:45', dept: '20:50' }, { city: 'Gaibandha', arr: '21:50', dept: '21:55' }, { city: 'Bogura', arr: '23:30', dept: '23:35' }, { city: 'Dhaka_Airport', arr: '04:55', dept: '05:00' }], offDay: 'Sunday' },
  '765': { name: 'Nilsagor Express', from: 'Dhaka', to: 'Chilahati', dept: '06:40', arr: '16:00', stops: [{ city: 'Dhaka_Airport', arr: '07:05', dept: '07:10' }, { city: 'Santahar', arr: '11:40', dept: '11:45' }, { city: 'Parbatipur', arr: '14:00', dept: '14:10' }, { city: 'Saidpur', arr: '14:35', dept: '14:40' }, { city: 'Nilphamari', arr: '15:10', dept: '15:15' }], offDay: 'Sunday' },
  '766': { name: 'Nilsagor Express', from: 'Chilahati', to: 'Dhaka', dept: '20:00', arr: '05:45', stops: [{ city: 'Nilphamari', arr: '20:45', dept: '20:50' }, { city: 'Saidpur', arr: '21:20', dept: '21:25' }, { city: 'Parbatipur', arr: '21:50', dept: '22:00' }, { city: 'Santahar', arr: '00:20', dept: '00:25' }, { city: 'Dhaka_Airport', arr: '05:10', dept: '05:15' }], offDay: 'Sunday' },
  
  // South Bengal & Mymensingh
  '805': { name: 'Chitra Express', from: 'Dhaka', to: 'Khulna', dept: '19:00', arr: '03:40', stops: [{ city: 'Dhaka_Airport', arr: '19:25', dept: '19:30' }, { city: 'Joydebpur', arr: '20:00', dept: '20:05' }, { city: 'Ishwardi', arr: '23:45', dept: '23:55' }, { city: 'Kushtia_Court', arr: '00:45', dept: '00:50' }, { city: 'Poradah', arr: '01:10', dept: '01:15' }, { city: 'Chuadanga', arr: '01:45', dept: '01:50' }, { city: 'Jashore', arr: '02:40', dept: '02:45' }], offDay: 'Monday' },
  '806': { name: 'Chitra Express', from: 'Khulna', to: 'Dhaka', dept: '08:40', arr: '17:30', stops: [{ city: 'Jashore', arr: '09:35', dept: '09:40' }, { city: 'Chuadanga', arr: '10:30', dept: '10:35' }, { city: 'Poradah', arr: '11:05', dept: '11:10' }, { city: 'Ishwardi', arr: '12:20', dept: '12:30' }, { city: 'Joydebpur', arr: '16:15', dept: '16:20' }, { city: 'Dhaka_Airport', arr: '16:50', dept: '16:55' }], offDay: 'Monday' },
  '725': { name: 'Sundarban Express', from: 'Dhaka', to: 'Khulna', dept: '08:15', arr: '15:50', stops: [{ city: 'Dhaka_Airport', arr: '08:40', dept: '08:45' }, { city: 'Bhanga', arr: '10:20', dept: '10:25' }, { city: 'Narail', arr: '12:30', dept: '12:35' }, { city: 'Jashore', arr: '13:40', dept: '13:45' }, { city: 'Daulatpur', arr: '15:20', dept: '15:23' }], offDay: 'Wednesday' },
  '726': { name: 'Sundarban Express', from: 'Khulna', to: 'Dhaka', dept: '21:45', arr: '05:10', stops: [{ city: 'Daulatpur', arr: '22:05', dept: '22:08' }, { city: 'Jashore', arr: '23:45', dept: '23:50' }, { city: 'Narail', arr: '00:55', dept: '01:00' }, { city: 'Bhanga', arr: '03:10', dept: '03:15' }, { city: 'Dhaka_Airport', arr: '04:35', dept: '04:40' }], offDay: 'Tuesday' },
  '795': { name: 'Benapole Express', from: 'Dhaka', to: 'Benapole', dept: '23:45', arr: '07:20', stops: [{ city: 'Dhaka_Airport', arr: '00:10', dept: '00:15' }, { city: 'Ishwardi', arr: '04:15', dept: '04:25' }, { city: 'Jashore', arr: '06:15', dept: '06:20' }], offDay: 'Wednesday' },
  '796': { name: 'Benapole Express', from: 'Benapole', to: 'Dhaka', dept: '13:00', arr: '20:45', stops: [{ city: 'Jashore', arr: '13:45', dept: '13:50' }, { city: 'Ishwardi', arr: '15:40', dept: '15:50' }, { city: 'Dhaka_Airport', arr: '20:10', dept: '20:15' }], offDay: 'Wednesday' },
  '777': { name: 'Haor Express', from: 'Dhaka', to: 'Mohanganj', dept: '10:15', arr: '15:45', stops: [{ city: 'Dhaka_Airport', arr: '10:40', dept: '10:45' }, { city: 'Joydebpur', arr: '11:15', dept: '11:20' }, { city: 'Gafargaon', arr: '12:35', dept: '12:40' }, { city: 'Mymensingh', arr: '13:30', dept: '13:40' }, { city: 'Netrokona', arr: '14:40', dept: '14:45' }], offDay: 'Wednesday' },
  '778': { name: 'Haor Express', from: 'Mohanganj', to: 'Dhaka', dept: '08:00', arr: '13:40', stops: [{ city: 'Netrokona', arr: '08:55', dept: '09:00' }, { city: 'Mymensingh', arr: '10:00', dept: '10:10' }, { city: 'Gafargaon', arr: '11:00', dept: '11:05' }, { city: 'Joydebpur', arr: '12:25', dept: '12:30' }, { city: 'Dhaka_Airport', arr: '13:00', dept: '13:05' }], offDay: 'Monday' },
  '735': { name: 'Agnibina Express', from: 'Dhaka', to: 'Tarakandi', dept: '11:00', arr: '17:00', stops: [{ city: 'Dhaka_Airport', arr: '11:25', dept: '11:30' }, { city: 'Joydebpur', arr: '12:00', dept: '12:05' }, { city: 'Mymensingh', arr: '14:15', dept: '14:25' }, { city: 'Jamalpur_Town', arr: '15:30', dept: '15:35' }, { city: 'Sarishabari', arr: '16:25', dept: '16:28' }], offDay: 'None' },
  '736': { name: 'Agnibina Express', from: 'Tarakandi', to: 'Dhaka', dept: '17:50', arr: '23:55', stops: [{ city: 'Sarishabari', arr: '18:15', dept: '18:18' }, { city: 'Jamalpur_Town', arr: '19:10', dept: '19:15' }, { city: 'Mymensingh', arr: '20:20', dept: '20:30' }, { city: 'Joydebpur', arr: '22:45', dept: '22:50' }, { city: 'Dhaka_Airport', arr: '23:20', dept: '23:25' }], offDay: 'None' },
  '707': { name: 'Tista Express', from: 'Dhaka', to: 'Dewanganj', dept: '07:30', arr: '12:50', stops: [{ city: 'Dhaka_Airport', arr: '07:55', dept: '08:00' }, { city: 'Joydebpur', arr: '08:30', dept: '08:35' }, { city: 'Mymensingh', arr: '10:35', dept: '10:45' }, { city: 'Piyarpur', arr: '11:15', dept: '11:18' }, { city: 'Jamalpur_Town', arr: '11:45', dept: '11:50' }], offDay: 'Monday' },
  '708': { name: 'Tista Express', from: 'Dewanganj', to: 'Dhaka', dept: '15:00', arr: '20:35', stops: [{ city: 'Jamalpur_Town', arr: '15:55', dept: '16:00' }, { city: 'Mymensingh', arr: '17:05', dept: '17:15' }, { city: 'Joydebpur', arr: '19:25', dept: '19:30' }, { city: 'Dhaka_Airport', arr: '20:00', dept: '20:05' }], offDay: 'Monday' },
  '743': { name: 'Brahmaputra Express', from: 'Dhaka', to: 'Dewanganj', dept: '18:15', arr: '23:45', stops: [{ city: 'Dhaka_Airport', arr: '18:40', dept: '18:45' }, { city: 'Joydebpur', arr: '19:15', dept: '19:20' }, { city: 'Mymensingh', arr: '21:30', dept: '21:40' }, { city: 'Jamalpur_Town', arr: '22:40', dept: '22:45' }], offDay: 'None' },
  '744': { name: 'Brahmaputra Express', from: 'Dewanganj', to: 'Dhaka', dept: '06:30', arr: '12:00', stops: [{ city: 'Jamalpur_Town', arr: '07:25', dept: '07:30' }, { city: 'Mymensingh', arr: '08:30', dept: '08:40' }, { city: 'Joydebpur', arr: '10:50', dept: '10:55' }, { city: 'Dhaka_Airport', arr: '11:25', dept: '11:30' }], offDay: 'None' }
};

function assignStationPlatform(stationClean, trainModel, direction) {
  const st = (stationClean || '').toLowerCase();
  const modNum = parseInt(trainModel, 10) || 0;
  
  if (st.includes('kamalapur') || st === 'dhaka') {
    if (['701', '702', '787', '788'].includes(trainModel)) return 'PF 1';
    if (['813', '814', '815', '816'].includes(trainModel)) return 'PF 3';
    if (['703', '704', '721', '722', '741', '742'].includes(trainModel)) return 'PF 2';
    if (['709', '710', '717', '718', '739', '740', '773', '774'].includes(trainModel)) return 'PF 4';
    if (['753', '754', '759', '760', '769', '770', '791', '792'].includes(trainModel)) return 'PF 5';
    if (['705', '706', '757', '758', '793', '794', '771', '772', '765', '766'].includes(trainModel)) return 'PF 6';
    if (['805', '806', '725', '726', '795', '796'].includes(trainModel)) return 'PF 7';
    return `PF ${(modNum % 7) + 1}`;
  }
  
  if (st.includes('airport')) {
    if (direction === 'to_dhaka' || direction === 'arrival') return 'PF 1 (Down)';
    return 'PF 2 (Up)';
  }
  
  if (st.includes('chattogram') || st.includes('chittagong')) {
    if (['701', '702', '787', '788'].includes(trainModel)) return 'PF 1';
    if (['813', '814', '815', '816'].includes(trainModel)) return 'PF 2';
    return `PF ${(modNum % 4) + 1}`;
  }

  if (st.includes('sylhet')) {
    return `PF ${(modNum % 3) + 1}`;
  }

  if (st.includes('rajshahi')) {
    return `PF ${(modNum % 4) + 1}`;
  }

  if (st.includes('khulna')) {
    return `PF ${(modNum % 3) + 1}`;
  }

  return `PF ${(modNum % 2) + 1}`;
}

app.get('/api/station-pids', async (req, res) => {
  const rawStation = req.query.station || 'Dhaka';
  const normTarget = rawStation.toLowerCase().replace(/[_\s-]/g, '');
  ...
  for (const [model, sched] of Object.entries(PIDS_INTERCITY_SCHEDULES)) {
    const fromNorm = sched.from.toLowerCase().replace(/[_\s-]/g, '');
    const toNorm = sched.to.toLowerCase().replace(/[_\s-]/g, '');
    
    let isOrigin = fromNorm.includes(normTarget) || normTarget.includes(fromNorm);
    let isDest = toNorm.includes(normTarget) || normTarget.includes(toNorm);
    let isStoppage = false;
    let stopInfo = null;

    if (!isOrigin && !isDest && sched.stops) {
      for (const st of sched.stops) {
        const sNorm = st.city.toLowerCase().replace(/[_\s-]/g, '');
        if (sNorm.includes(normTarget) || normTarget.includes(sNorm)) {
          isStoppage = true;
          stopInfo = st;
          break;
        }
    ...
    if (!isOrigin && !isDest && !isStoppage) continue;

    let schedDept = isOrigin ? sched.dept : (stopInfo ? stopInfo.dept : null);
    let schedArr = isDest ? sched.arr : (stopInfo ? stopInfo.arr : null);

    let timeForCompare = schedDept || schedArr;
    let [h, m] = timeForCompare.split(':').map(Number);
    let schedMinutes = h * 60 + m;
    let diff = schedMinutes - currentMinutes;

    let status = 'ON TIME';
    let statusBn = 'সময়মতো';
    ...
    if (diff < -45) {
      ...
      status = 'DELAYED';
      statusBn = `বিলম্বিত (+${Math.abs(diff)} মি.)`;
      statusColor = 'rose';
      delayMin = Math.abs(diff);
    } else if (diff >= 0 && diff <= 15) {
      status = isDest ? 'ARRIVING' : 'BOARDING NOW';
      statusBn = isDest ? 'আসছে' : 'যাত্রী গ্রহণ';
      statusColor = 'amber';
    ...
    const direction = toNorm.includes('dhaka') ? 'to_dhaka' : 'from_dhaka';
    const platform = assignStationPlatform(rawStation, model, isDest ? 'arrival' : direction);

    entries.push({
      model: model,
      name: sched.name,
      from: sched.from.replace(/_/g, ' '),
      to: sched.to.replace(/_/g, ' '),
      route: `${sched.from.replace(/_/g, ' ')} ➔ ${sched.to.replace(/_/g, ' ')}`,
      is_origin: isOrigin,
      is_destination: isDest,
      is_stoppage: isStoppage,
      scheduled_departure: schedDept,
      scheduled_arrival: schedArr,
      display_time: schedDept || schedArr,
      platform: platform,
      status: status,
      status_bn: statusBn,
      status_color: statusColor,
      delay_min: delayMin,
      off_day: sched.offDay,
  ...
  entries.sort((a, b) => {
    const [hA, mA] = a.display_time.split(':').map(Number);
    const [hB, mB] = b.display_time.split(':').map(Number);
    return (hA * 60 + mA) - (hB * 60 + mB);
  });

  const bstTimeString = bdTime.toLocaleTimeString('en-US', { hour12: true, hour: '2-digit', minute: '2-digit', second: '2-digit' });

  res.json({
    success: true,
    station: rawStation,
    station_clean: rawStation.replace(/_/g, ' '),
    current_time_bst: bstTimeString,
    total_movements: entries.length,
    departures: entries.filter(e => !e.is_destination),
    arrivals: entries.filter(e => e.is_destination || e.is_stoppage),
    all: entries
  });
});
